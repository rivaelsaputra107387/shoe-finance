                    ...
                    <div className="p-6 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
                        ...
                        <div className="space-y-3">
                            {data.lines.map((line, idx) => (
                                <div key={idx} className="flex flex-col md:flex-row items-center gap-3 p-3 bg-gray-50/50 dark:bg-gray-800/40 rounded-xl border border-gray-200/60 dark:border-gray-700/60">
                                    <div className="flex-1 w-full">
                                        <select
                                            value={line.account_id}
                                            onChange={(e) => handleLineChange(idx, 'account_id', e.target.value)}
                                            required
                                            className="w-full py-2 px-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-medium text-gray-900 dark:text-white"
                                        >
